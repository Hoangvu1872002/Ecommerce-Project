    ...
    <div className="w-full ">
      ...
      <div className=" h-[407px] w-full bg-gray-900 flex items-center justify-center text-white text-[13px]">
        <div className="w-main flex">
          ...
          <span className="opacity-70 hover:opacity-100 cursor-pointer">Typography</span>
          <span className="opacity-70 hover:opacity-100 cursor-pointer">Gallery</span>
          <span className="opacity-70 hover:opacity-100 cursor-pointer">Store Location</span>
          <span className="opacity-70 hover:opacity-100 cursor-pointer">Today's Deals</span>
          ...
          <span className="opacity-70 hover:opacity-100 cursor-pointer">Free Shipping</span>
          <span className="opacity-70 hover:opacity-100 cursor-pointer">FAQs</span>
          <span className="opacity-70 hover:opacity-100 cursor-pointer">Return & Exchange</span>
          <span className="opacity-70 hover:opacity-100 cursor-pointer">Testimonials</span>
          </div>
